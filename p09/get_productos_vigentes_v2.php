    ...
    if (!isset($_GET['tope']) || !preg_match('/^\d+$/', $_GET['tope'])) {
        ...
        if ($link->connect_errno) {
            ...
            if ($result->num_rows > 0) {
                ...
                echo '<tr><th>#</th><th>Nombre</th><th>Marca</th><th>Modelo</th><th>Precio</th><th>Unidades</th><th>Detalles</th><th>Imagen</th><th>Modificar</th></tr>';
                echo '</thead><tbody>';
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<td> <a href="http://localhost/tecweb/practica1/p09/modificar_productos.php?id=' . htmlspecialchars($row['id']) . '" class="btn btn-warning">Modificar</a></td>';
                    echo '</tr>';
                }
